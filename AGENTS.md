...
- Текущая продуктовая цель и карта юморного контура: `docs/LLM_CONTEXT.md`.
...
- `ARCHITECTURE.MD` — фактические границы модулей, состояние, фоновые контуры и проверка изменений.
